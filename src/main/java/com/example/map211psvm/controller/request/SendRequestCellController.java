...
public class SendRequestCellController extends ListCell<User> {
    ...
    protected void updateItem(User friend, boolean empty){
        ...
        var loader = new FXMLLoader(Main.class.getResource("request/requestSendCell.fxml"));
        ...
        cancelButton.setOnAction(event -> superService.friendshipService.delete(user.getId(), friend.getId()));
