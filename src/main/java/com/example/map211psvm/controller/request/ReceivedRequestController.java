...
public class ReceivedRequestController implements PropertyChangeListener {
    ...
    public ReceivedRequestController() {
    ...
    public void initialize() {
        ...
        listView.setCellFactory(x -> {
            var cell = new ReceivedRequestCellController();
    ...
    public void initModel() {
        var requests = superService.friendshipService.findAllRequestsForAUser(user);
